...
static struct clk_regmap sm1_dsu_clk_mux0_div = {
	...
	.hw.init = &(struct clk_init_data){
		...
		.ops = &clk_regmap_divider_ro_ops,
		.parent_names = (const char *[]){ "dsu_clk_dyn0_sel" },
		.num_parents = 1,
	},
};
...
static struct clk_regmap sm1_dsu_clk_mux1_div = {
	...
	.hw.init = &(struct clk_init_data){
		...
		.ops = &clk_regmap_divider_ro_ops,
		.parent_names = (const char *[]){ "dsu_clk_dyn1_sel" },
		.num_parents = 1,
	},
};
...
static struct clk_regmap sm1_dsu_clk_dyn = {
	...
	.hw.init = &(struct clk_init_data){
		.name = "dsu_clk_dyn",
		.ops = &clk_regmap_mux_ro_ops,
		.parent_names = (const char *[]){ "dsu_clk_dyn0",
						  "dsu_clk_dyn1" },
		.num_parents = 2,
	},
};
...
static struct clk_regmap sm1_dsu_final_clk = {
	...
	.hw.init = &(struct clk_init_data){
		.name = "dsu_clk_final",
		.ops = &clk_regmap_mux_ro_ops,
		.parent_names = (const char *[]){ "dsu_clk_dyn",
						  "sys_pll" },
		.num_parents = 2,
	},
};
...
static struct clk_regmap sm1_dsu_clk = {
	...
	.hw.init = &(struct clk_init_data){
		.name = "dsu_clk",
		.ops = &clk_regmap_mux_ro_ops,
		.parent_names = (const char *[]){ "dsu_clk_final",
						  "cpu_clk" },
		.num_parents = 2,
	},
};
